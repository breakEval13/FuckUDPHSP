...
package fuck.gfw.server;

import fuck.gfw.rudp.ConnectionProcessor;
import fuck.gfw.rudp.Route;
import fuck.gfw.utils.MLog;

import java.io.*;
import java.net.BindException;

public class FUCKServer {
	...
	static FUCKServer get() {
		return udpServer;
	}

	public FUCKServer() throws Exception {
		MLog.info("");
		MLog.info("FUCKUDP server starting... ");
